import { Card, CardHeader, CardTitle, CardDescription, CardContent, SelectContent, Select, SelectItem, SelectTrigger, SelectValue } from "components/ui";
...
interface Props {
 ...
 export const UserDataChart = ( props: Props ) => {
    ...
    const userData = useMemo(() => {
      return data.filter(record => record.user_id === selectedUser)
        ...
        <CardContent>
          ...
          <div ref={chartContainerRef} style={{ width: '100%', height: '300px' }}>
            <LineChart data={userData} width={chartWidth} height={chartHeight}>
              ...
              <XAxis dataKey="created_at" tickFormatter={(value) => new Date(value).toLocaleDateString('ja-JP')} />
              <YAxis />
              <Tooltip labelFormatter={(value) => new Date(value).toLocaleDateString('ja-JP')} />
              <Legend />
